...
public class SalesServiceImpl implements SalesService {
    ...
    /*确认发货*/
    public int updateAdminOrder(String invoiceNo) {
        return salesMapper.updateAdminOrder(invoiceNo);
    }

    /*
    * 取消发货*/
    public int updateAdminOrder1(String invoiceNo) {
        return salesMapper.updateAdminOrder1(invoiceNo);
    }

    /*
    * 确认收货*/
    public int updateStatus(String invoiceNo) {return  salesMapper.updateStatus(invoiceNo);}
    ...
    /*
    * 收货*/
    public List<Sales> selectByCustId3(int custId) {
        List<Sales> salesList = salesMapper.selectByCustId3(custId);
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        for (int i = 0; i < salesList.size(); i++) {
            salesList.get(i).setExtend2(format.format(salesList.get(i).getOrderDate()));
        }
    ...
    /*
     * 已收货*/
    public List<Sales> selectByCustId4(int custId) {
        List<Sales> salesList = salesMapper.selectByCustId4(custId);
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        for (int i = 0; i < salesList.size(); i++) {
            salesList.get(i).setExtend2(format.format(salesList.get(i).getOrderDate()));
        }
