...
//    	System.out.println(time);
    ...
    public static Date plusDay(int num, String newDate) throws ParseException {
        String s1 = newDate.substring(0, 4) + "-" + newDate.substring(4, 6) + "-" + newDate.substring(6, 8) + " " + newDate.substring(8, 10) + ":" + newDate.substring(10, 12) + ":" + newDate.substring(12, 14);
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date currdate = format.parse(s1);
     ...
     * @return
     */
    public static Boolean subtractTime(String nowDate, String endDate) {
        Boolean b = false;
        //SimpleDateFormat format = new SimpleDateFormat("yyyyMMddHHmmss");
        Long nowdate = new Long(nowDate);
        Long enddate = new Long(endDate);
